...
if($_GET['funcao'] == "gravar_client"){

$inserepdopf=$pdo->prepare("INSERT INTO vedido (nome, tipo, plano, valor, data) value
	(
'$nome', 	
'$tipo', 			
'$plano', 
...
if($_GET['funcao'] == "editar_client"){
$id = $_GET['id'];
$insertaleracao=$pdo->prepare("UPDATE vedido SET 
nome='$nome', 	               	
tipo='$tipo', 			               
plano='$plano',                
valor='$valor', 	               
...
////$FUNÇÃO PARA EXCLUIR
////
if($_GET['funcao'] == "excluir_client"){
$id = $_GET['id'];
$sql_del_serv = $pdo->prepare('DELETE FROM vedido WHERE id = :id');
