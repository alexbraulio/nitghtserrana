    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Cadastro de contrato vendido.</h4>
        </div>
...
<div class="row">
  ...
  ?>
               <div class="col-md-12">
            <form method="post" role="form" action="funcoes.php?funcao=gravar_client">
              <div class="form-group">
                ...
                <label class="control-label" for="sel1">Plano:</label>
                                    <select name="plano" type="text"class="form-control" id="plano">
...
<div class="row">
     <div class="col-md-12">
            <form method="post" role="form" enctype="multipart/form-data" action="funcoes.php?funcao=editar_client&id=<?php echo  $linha['id'] ?>">
              <div class="form-group">
                ...
                <label class="control-label" for="marca">data:</label>
                <input name="data" type="date"class="form-control" id="data" value="<?php echo   $linha['data'];                                     ?>">
...
<div class="modal fade" id="exampleModal<?php echo  $linha['id']  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <a href="funcoes.php?funcao=excluir_client&id=<?php echo  $linha['id'] ?>" role="button"  type="button" class="btn btn-lg btn-danger">Excluir </a> 
      </div>
